...
struct ContentView: View {
    //let students = [Student(name: "Harry")]
    /* When saving coredata
     if moc.hasChanges {
         try? moc.save()
     }
     */
    ...
    let sortDescript = NSSortDescriptor(key: "lastName", ascending: true)
    ...
    var body: some View {
        ...
        VStack{
            FilteredList(predic: .beginsWith, sortDescript: sortDescript,  filterKey: "lastName", filterValue: lastNameFilter) { (singer: Singer) in
